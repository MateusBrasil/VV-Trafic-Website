...
/* ── SVG flag icons (emoji flags render as text on Windows) ── */
const FlagPT = () => (
  <svg width="22" height="15" viewBox="0 0 22 15" xmlns="http://www.w3.org/2000/svg"
    style={{ borderRadius: 3, flexShrink: 0, display: 'block', boxShadow: '0 0 0 1px rgba(255,255,255,0.12)' }}>
            ...
            {LANGUAGES.map((l) => {
              ...
              return (
                <button
                  ...
                  style={{
                    ...itemBase,
                    color: isSelected ? '#c6f221' : 'rgba(255,255,255,0.7)',
